...
function update-configFile($docTitle, $fileName) {
    ...
    $conf = "/Users/salius/copenhagen_theme/zendesk\config.yaml"
...
function publish-toZendesk {
    ...
    $scriptFolder = "/Users/salius/copenhagen_theme/zendesk"
    $scriptFile = "publish.js"
    cd..
    git add . 
    git commit -m "zendesk updates" 
    git push
    Start-Process node $scriptFile -WorkingDirectory $scriptFolder 
    Write-Host "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" -foregroundcolor Darkcyan
    Write-Host "new documentation pushed to zendesk" -foregroundcolor Darkcyan
    Write-Host "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" -foregroundcolor Darkcyan
}
