...
async function publish() {
  ...
  for (const section of config.sections || []) {
    for (const art of section.articles || []) {
      ...
      const staticAssetsUrl = 'https://github.com/Quadrisheriff/copenhagen_theme/blob/master/assets/$2.$3?raw=true';
      ...
      if (hash !== art.hash) {
        ...
        art.webLink = `https://xmcyber-test.zendesk.com/hc/en-us${art.id}`
      }
    }
  }
